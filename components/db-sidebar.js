    ...
    this._shadow.innerHTML = `
      <style>
        ...
        :host {
          ...
          /* Herda as CSS Custom Properties do documento host (index.html).
           * Se não existirem, aplica os fallbacks abaixo. */
          --navy:   var(--navy, #003761);
          --navy2:  var(--navy2, #002a4d);
          --navy3:  var(--navy3, #004a80);
          --accent: var(--accent, #0F9B94);
          --accent2:var(--accent2,#0a7a74);
          --gold:   var(--gold,  #C49B3C);
          --r:      var(--r,     6px);
          --font:   var(--font,  'Segoe UI', system-ui, sans-serif);
